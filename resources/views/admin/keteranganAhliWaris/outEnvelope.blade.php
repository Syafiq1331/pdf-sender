@extends('layouts.admin', ['title' => 'Keterangan Ahli Waris'])
    ...
    <div class="card">
        <div class="card-body">
            <table class="table">
                ...
                <tbody>
                    @forelse ($keteranganAhliWaris as $data)
                        <tr>
                            <td>{{ $data->nama }}</td>
                            ...
                            <td>
                                <form action="{{ route('surat-keterangan-ahli-waris.update_status', $data->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                            ...
                            <td>
                                <form action="{{ route('surat-keterangan-ahli-waris.update_verifikasi', $data->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                            ...
                            <td>
                                <form action="{{ route('surat-keterangan-ahli-waris.generate_pdf_single', $data->id) }}"
                                    method="GET">
