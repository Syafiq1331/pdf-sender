@extends('layouts.admin', ['title' => 'Keterangan Usaha'])
    ...
    <div class="card">
        <div class="card-body">
            <table class="table">
                ...
                <tbody>
                    @foreach ($keteranganUsaha as $data)
                        <tr>
                            <td>{{ $data->nama }}</td>
                            <td>{{ $data->nik }}</td>
                            ...
                            <td>
                                <form action="{{ route('surat-keterangan-usaha.update_status', $data->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                            ...
                            <td>
                                <form action="{{ route('surat-keterangan-usaha.update_verifikasi', $data->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                            ...
                            <td>
                                <form action="{{ route('surat-keterangan-usaha.generate_pdf_single', $data->id) }}"
                                    method="GET">
