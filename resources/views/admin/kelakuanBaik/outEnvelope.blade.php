@extends('layouts.admin', ['title' => 'Kelakuan Baik'])
                ...
                <tbody>
                    @forelse ($kelakuanBaik as $data)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('surat-keterangan-kelakuan-baik.update_status', $data->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                            ...
                            <td>
                                <form action="{{ route('surat-keterangan-kelakuan-baik.update_verifikasi', $data->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                            ...
                            <td>
                                <form action="{{ route('surat-keterangan-kelakuan-baik.generate_pdf_single', $data->id) }}"
                                    method="GET">
